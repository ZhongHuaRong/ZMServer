...
public:
    ...
    SIGNUPERRORCODE signup(const char *accountNumber,const char *pw);
    bool registered(const char *accountNumber,const char *pw,const char *userName);
...
private:
    void updateUserLoginState(bool state);
    void setColumnName();
